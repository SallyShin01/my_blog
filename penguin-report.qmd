...
부리 길이 변수의 결측치 개수는 `{python} int(na_check.iloc[2])`개 입니다.
<br>
<br>
...
print(species_means)
species_means.columns = ["부리길이", "부리깊이","날개깊이","몸무개","관측년도"]
species_means.index.names["펭귄  종","성별"]
